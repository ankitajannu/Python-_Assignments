...
def UpdateHistory(zip_file, file_count):
    ...
    with open(history_file, "a") as fobj:
        ...
        fobj.write(f"Files : {file_count} | ")
        fobj.write(f"Zip : {zip_file} | ")
        fobj.write(f"Size : {size:.2f}KB\n")
...
def DisplayHistory():
    ...
    print("-"*50)
    print("Backup History".center(50))
    print("-"*50)
...
def main():
    ...
    if(len(sys.argv) == 2):
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H"):
            ...
            print("5 : Display Backup history")
